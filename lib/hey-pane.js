...
export default {
  ...
  config: {
    ...
    followModeByDefault: {
        title: 'Enable Follow Mode by Default (Restart Required)',
        description: 'If this box is checked then Follow Mode will be enabled by default every time you start Atom.',
        type: 'boolean',
        default: false
    }
  },
